...
void handleGetButtons(const String &args) {
    Serial.printf("%i ", !digitalRead(BUTTON_UP));
    Serial.printf("%i ", !digitalRead(BUTTON_DOWN));
    Serial.printf("%i ", !digitalRead(BUTTON_LEFT));
    Serial.printf("%i ", !digitalRead(BUTTON_RIGHT));
    Serial.printf("%i ", !digitalRead(BUTTON_LIFT_UP));
    Serial.printf("%i\n", !digitalRead(BUTTON_LIFT_DOWN));
}
